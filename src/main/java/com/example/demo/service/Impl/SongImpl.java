...
public class SongImpl implements SongService {
    ...
    public List<Integer> getPushSongPoint(String userid){
        return songMapper.getPushSongsPoints(userid);
    }

    public double getSiteTypePercent(String type){
        Map<String,Object>map = new HashMap<>();
        map.put("t",type);
        songMapper.getSiteTypePercent(map);
